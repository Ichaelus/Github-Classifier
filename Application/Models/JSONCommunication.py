...
def formatMultipleClassificationTests(results):
	...
	for result in results:
		classificators[result[0]] = {'result':formatClassificatorAccuracy(results[1][1]), 'yield':results[1][0]}
	returndata = {'classificators':classificators}
	return json.dumps(returndata)	
...
def formatSavePoints(savePoints):
	...
	for savePoint in savePoints:
		savePoints[savePoint[0]] = {'result':formatClassificatorAccuracy(savePoint[1]), 'yield':savePoint[2]}
	returndata = {'savepoints': savePoints}
	return json.dumps(returndata)
